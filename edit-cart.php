<?php
    ...
    {
        $conn = connection();
        $sql = "SELECT items.item_name, items.item_price, carts.quantity FROM carts INNER JOIN items ON carts.item_id = items.id WHERE carts.id = $id";
...
<body>
    ...
    <main class="row justify-content-center">
        <div class="col-4">
            <h2 class="fw-bold mb-3"><i class="fa-solid fa-cart-plus"></i> Edit Cart</h2>
            ...
            <form action="#" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="quantity" id="quantity" step="any" class="form-control" value="<?=$item['quantity']?>" required autofocus>
                </div>
